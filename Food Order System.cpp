...
int main(){
	...
	head = NULL;
	insertfirst(5,"Cakes",23,120.23);
	insertend(6,"Mo:Mo    ",13,100.67);
	insertend(1,"Pasta",8,720.83);
	insertend(2,"Coffee  ",46,70.23);
	insertend(3,"Frech Fries ",46,70.23);
	insertend(4,"Chicken Tandoori ",34,60.23);
		...
		if(main_menu_choice == 1){
			...
			if(admin_panel_choice==1234567){
				...
				if(adminchoise==1){
					...
					br(3);pre(4);      printf(" Enter Food Item Name :  ");
...
void main_menu(){
	...
	cls();
	br(5); pre(3); echo(">> 1. View Food List"); Sleep(400);
